...
local currentHideKey = key -- Stocke la touche actuelle

-- Fonction pour mettre à jour la touche de masquage
library.UpdateHideKey = function(newKey)
    currentHideKey = newKey
    return "Touche mise à jour: " .. newKey.Name
end

-- Connexion pour masquer/afficher le GUI
UserInputService.InputBegan:Connect(function(input)
    if CanChangeVisibility and input.KeyCode == currentHideKey then
